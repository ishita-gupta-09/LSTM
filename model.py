...
config = {
    "data_csv": "",  # Path to your CSV data file. Leave empty to generate synthetic data.
    "seq_len": 32,
    "latent_dim": 16,
    "epochs": 50,
    "batch_size": 64,
    "out_dir": "out_model",
    "yellow_threshold_percentile": 95.0, # Percentile for Yellow Signal
    "red_threshold_percentile": 99.5    # Percentile for Red Signal
}
...
inputs = layers.Input(shape=(config["seq_len"], 2))
...
outputs = layers.TimeDistributed(layers.Dense(2))(decoded)
